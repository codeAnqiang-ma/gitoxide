...
// Keep this identical to JJ's `hex_util::REVERSE_HEX_CHARS` and its high-nibble-first encoder:
// https://github.com/jj-vcs/jj/blob/main/lib/src/hex_util.rs
...
impl ChangeId {
    /// Parse a complete SHA-1 or SHA-256 hash written with Jujutsu's reverse-hex alphabet.
    ...
    /// Return a type which displays this ID in Jujutsu-compatible reverse-hex notation.
